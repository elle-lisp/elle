...
(assert-true (parameter? (parameter 1)) "parameter? on parameter")
...
(assert-eq ((parameter 42)) 42 "call parameter reads default int")
(assert-eq ((parameter "hello")) "hello" "call parameter reads default string")
(assert-eq ((parameter nil)) nil "call parameter reads default nil")
...
(assert-true (parameter? (parameter 42))
  "parameter returns parameter type")

# parameter_type_of
(assert-eq (type (parameter 0)) :parameter
  "type-of parameter is :parameter")

# parameter_call_with_args_errors
(assert-err (fn () ((parameter 42) 1))
