...
(assert (= (match 1
             (or 1 3 5) :odd
             _ :even) :odd) "or-pattern: 1 is odd")

(assert (= (match 2
             (or 1 3 5) :odd
             _ :even) :even) "or-pattern: 2 is even")

(assert (= (match 3
             (or 1 3 5) :odd
             _ :even) :odd) "or-pattern: 3 is odd")

(assert (= (match 5
             (or 1 3 5) :odd
             _ :even) :odd) "or-pattern: 5 is odd")

(assert (= (match 4
             (or 1 3 5) :odd
             _ :even) :even) "or-pattern: 4 is even")
