...
(assert (= (subprocess/wait (subprocess/exec "true" [])) 0) "subprocess/wait: /bin/true exits 0")
...
(assert (= (get (subprocess/system "echo" ["hello"]) :exit) 0) "subprocess/system: echo exits 0")
...
(assert (= (get (subprocess/system "true" ()) :exit) 0) "subprocess/system: empty list args work")
