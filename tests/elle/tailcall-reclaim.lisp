...
(def before-100 (get (arena/stats) :object-count))
(tail-alloc 100)
(def delta-100 (%sub (get (arena/stats) :object-count) before-100))
(def before-10k (get (arena/stats) :object-count))
(tail-alloc 10000)
(def delta-10k (%sub (get (arena/stats) :object-count) before-10k))
