(elle/epoch 12)
# audited: 2026-09-23
# The value udp/send-to resumes with is an immediate, as its Immediate region effect declares.
# docs/impl/region/effects.md
#
# The io completion of udp/send-to returns (SIG_OK . result_code) — the number of bytes sent —
...
# result ever a heap value, `Immediate` would be unsound and this pin fails.
#
...
# three heap args, hence no per-call leak — is pinned by
# `udp_send_to_declares_immediate_no_arg_clique` in
