(def {:assert-eq assert-eq :assert-true assert-true :assert-string-eq assert-string-eq} ((import-file "tests/elle/assert.lisp")))
...
(assert-string-eq
  (bytes->hex (hmac-sha256-fn "key" "message"))
