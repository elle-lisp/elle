...
# region released by a tail-call deferred release — the capturing cell owns that release.
#
...
# Pinned under the UAF oracle by `region_selfrec_captured_tail_release`
