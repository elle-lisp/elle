...
(assert (string/contains? prim-triples "\"cons\"")
  "primitives contain cons")
...
(assert (= (rdf:encode-name "foo/bar") "foo%2Fbar")
  "encode-name encodes /")
(assert (= (rdf:encode-name "empty?") "empty%3F")
  "encode-name encodes ?")
(assert (= (rdf:encode-name "a:b") "a%3Ab")
  "encode-name encodes :")

# ── Literal escaping ──────────────────────────────────────────────────

(assert (= (rdf:lit "hello") "\"hello\"")
  "lit wraps in quotes")
