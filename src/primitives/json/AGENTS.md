...
|------|-------|--------|---------|
| `json/parse` | 1 | Pure | Parse JSON string to Elle value |
| `json/serialize` | 1 | Pure | Serialize Elle value to compact JSON |
| `json/serialize-pretty` | 1 | Pure | Serialize Elle value to pretty JSON |
