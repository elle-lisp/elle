...
| `image` | Image persistence: dump a sealed value graph as page bytes + relocations, hydrate by private mapping from a descriptor and an offset ([image.md](../docs/impl/image.md)) |
