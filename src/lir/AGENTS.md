...
| `intrinsics.rs` | ~55 | `IntrinsicOp` enum, intrinsics map, `PrimitiveClassification` |
| `lower/mod.rs` | ~280 | `Lowerer` struct, context, entry point, region instruction emission |
