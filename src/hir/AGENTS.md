...
16. **Original syntax is captured for eval reconstruction.**
...
19. **Files compile to a single synthetic letrec.** `analyze_file_letrec`
...
20. **Primitives are pre-bound as immutable Global bindings.** `bind_primitives`
