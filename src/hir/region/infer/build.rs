...
impl RegionInference {
    ...
    pub(super) fn build_info(self) -> RegionInfo {
        ...
        RegionInfo {
            ...
            frame_held_regions: rustc_hash::FxHashSet::default(),
            value_routed_regions: rustc_hash::FxHashSet::default(),
            ...
            opaque_result_aliases: self.opaque_result_aliases,
            funnel_result_containers: self.funnel_result_containers,
            ...
            // Populated by the `region::infer::ownership` post-pass in
            ...
            // Populated by the `region::infer::ownership` post-pass in `analyze_regions_with`
            ...
            // Populated by the `region::infer::compensate` post-pass in
