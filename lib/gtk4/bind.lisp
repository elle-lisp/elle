...
(ffi/defbind gtk-widget-set-visible   libgtk "gtk_widget_set_visible"    :void  [:ptr :int])
(ffi/defbind gtk-widget-set-sensitive libgtk "gtk_widget_set_sensitive"  :void  [:ptr :int])
(ffi/defbind gtk-widget-set-size-request libgtk "gtk_widget_set_size_request" :void [:ptr :int :int])
(ffi/defbind gtk-widget-set-hexpand libgtk "gtk_widget_set_hexpand"      :void  [:ptr :int])
(ffi/defbind gtk-widget-set-vexpand libgtk "gtk_widget_set_vexpand"      :void  [:ptr :int])
(ffi/defbind gtk-widget-add-css-class libgtk "gtk_widget_add_css_class"  :void  [:ptr :string])
(ffi/defbind gtk-widget-set-margin-start  libgtk "gtk_widget_set_margin_start"  :void [:ptr :int])
(ffi/defbind gtk-widget-set-margin-end    libgtk "gtk_widget_set_margin_end"    :void [:ptr :int])
(ffi/defbind gtk-widget-set-margin-top    libgtk "gtk_widget_set_margin_top"    :void [:ptr :int])
...
(ffi/defbind gtk-label-set-xalign libgtk "gtk_label_set_xalign"         :void  [:ptr :float])
...
(ffi/defbind gtk-button-set-label libgtk "gtk_button_set_label"          :void  [:ptr :string])
...
(ffi/defbind gtk-toggle-button-new-with-label libgtk "gtk_toggle_button_new_with_label" :ptr [:string])
(ffi/defbind gtk-toggle-button-set-active libgtk "gtk_toggle_button_set_active" :void [:ptr :int])
(ffi/defbind gtk-toggle-button-get-active libgtk "gtk_toggle_button_get_active" :int  [:ptr])

# ── GtkEntry (text-input) ────────────────────────────────────────

(ffi/defbind gtk-entry-new        libgtk "gtk_entry_new"                 :ptr   [])
(ffi/defbind gtk-entry-set-placeholder-text libgtk "gtk_entry_set_placeholder_text" :void [:ptr :string])
(ffi/defbind gtk-editable-get-text libgtk "gtk_editable_get_text"        :ptr   [:ptr])
(ffi/defbind gtk-editable-set-text libgtk "gtk_editable_set_text"        :void  [:ptr :string])

# ── GtkTextView (text-edit) ──────────────────────────────────────

(ffi/defbind gtk-text-view-new    libgtk "gtk_text_view_new"             :ptr   [])
(ffi/defbind gtk-text-view-get-buffer libgtk "gtk_text_view_get_buffer"  :ptr   [:ptr])
(ffi/defbind gtk-text-view-set-wrap-mode libgtk "gtk_text_view_set_wrap_mode" :void [:ptr :int])
(ffi/defbind gtk-text-view-set-editable libgtk "gtk_text_view_set_editable" :void [:ptr :int])
(ffi/defbind gtk-text-buffer-set-text libgtk "gtk_text_buffer_set_text"  :void  [:ptr :string :int])
(ffi/defbind gtk-text-buffer-get-start-iter libgtk "gtk_text_buffer_get_start_iter" :void [:ptr :ptr])
(ffi/defbind gtk-text-buffer-get-end-iter libgtk "gtk_text_buffer_get_end_iter" :void [:ptr :ptr])
(ffi/defbind gtk-text-buffer-get-text libgtk "gtk_text_buffer_get_text"  :ptr   [:ptr :ptr :ptr :int])

# ── GtkCheckButton ───────────────────────────────────────────────

(ffi/defbind gtk-check-button-new-with-label libgtk "gtk_check_button_new_with_label" :ptr [:string])
(ffi/defbind gtk-check-button-set-active libgtk "gtk_check_button_set_active" :void [:ptr :int])
(ffi/defbind gtk-check-button-get-active libgtk "gtk_check_button_get_active" :int  [:ptr])

# ── GtkSwitch ────────────────────────────────────────────────────

(ffi/defbind gtk-switch-new       libgtk "gtk_switch_new"                :ptr   [])
(ffi/defbind gtk-switch-set-active libgtk "gtk_switch_set_active"        :void  [:ptr :int])
(ffi/defbind gtk-switch-get-active libgtk "gtk_switch_get_active"        :int   [:ptr])

# ── GtkScale (slider) ────────────────────────────────────────────

(ffi/defbind gtk-scale-new-with-range libgtk "gtk_scale_new_with_range"  :ptr   [:int :double :double :double])
(ffi/defbind gtk-range-get-value  libgtk "gtk_range_get_value"           :double [:ptr])
(ffi/defbind gtk-range-set-value  libgtk "gtk_range_set_value"           :void  [:ptr :double])

# ── GtkSpinButton ────────────────────────────────────────────────

(ffi/defbind gtk-spin-button-new-with-range libgtk "gtk_spin_button_new_with_range" :ptr [:double :double :double])
(ffi/defbind gtk-spin-button-get-value libgtk "gtk_spin_button_get_value" :double [:ptr])
(ffi/defbind gtk-spin-button-set-value libgtk "gtk_spin_button_set_value" :void  [:ptr :double])
...
(ffi/defbind gtk-drop-down-get-selected libgtk "gtk_drop_down_get_selected" :uint [:ptr])
(ffi/defbind gtk-drop-down-set-selected libgtk "gtk_drop_down_set_selected" :void [:ptr :uint])
...
(ffi/defbind gtk-progress-bar-set-fraction libgtk "gtk_progress_bar_set_fraction" :void [:ptr :double])
(ffi/defbind gtk-progress-bar-get-fraction libgtk "gtk_progress_bar_get_fraction" :double [:ptr])
...
(ffi/defbind gtk-scrolled-window-set-child libgtk "gtk_scrolled_window_set_child" :void [:ptr :ptr])
(ffi/defbind gtk-scrolled-window-set-min-content-height libgtk "gtk_scrolled_window_set_min_content_height" :void [:ptr :int])
(ffi/defbind gtk-scrolled-window-set-min-content-width  libgtk "gtk_scrolled_window_set_min_content_width"  :void [:ptr :int])

# ── GtkExpander ───────────────────────────────────────────────────

(ffi/defbind gtk-expander-new     libgtk "gtk_expander_new"              :ptr   [:string])
(ffi/defbind gtk-expander-set-child libgtk "gtk_expander_set_child"      :void  [:ptr :ptr])
(ffi/defbind gtk-expander-set-expanded libgtk "gtk_expander_set_expanded" :void [:ptr :int])

# ── GtkFrame ──────────────────────────────────────────────────────

(ffi/defbind gtk-frame-new        libgtk "gtk_frame_new"                 :ptr   [:string])
(ffi/defbind gtk-frame-set-child  libgtk "gtk_frame_set_child"           :void  [:ptr :ptr])

# ── GtkGrid ──────────────────────────────────────────────────────

(ffi/defbind gtk-grid-new         libgtk "gtk_grid_new"                  :ptr   [])
(ffi/defbind gtk-grid-attach      libgtk "gtk_grid_attach"               :void  [:ptr :ptr :int :int :int :int])
(ffi/defbind gtk-grid-set-row-spacing    libgtk "gtk_grid_set_row_spacing"    :void [:ptr :int])
(ffi/defbind gtk-grid-set-column-spacing libgtk "gtk_grid_set_column_spacing" :void [:ptr :int])

# ── GtkStack / GtkStackPage ──────────────────────────────────────

(ffi/defbind gtk-stack-new        libgtk "gtk_stack_new"                 :ptr   [])
(ffi/defbind gtk-stack-add-titled libgtk "gtk_stack_add_titled"          :ptr   [:ptr :ptr :string :string])
(ffi/defbind gtk-stack-set-visible-child-name libgtk "gtk_stack_set_visible_child_name" :void [:ptr :string])
(ffi/defbind gtk-stack-get-visible-child-name libgtk "gtk_stack_get_visible_child_name" :ptr  [:ptr])

# ── GtkNotebook ──────────────────────────────────────────────────

(ffi/defbind gtk-notebook-new     libgtk "gtk_notebook_new"              :ptr   [])
(ffi/defbind gtk-notebook-append-page libgtk "gtk_notebook_append_page"  :int   [:ptr :ptr :ptr])
(ffi/defbind gtk-notebook-get-current-page libgtk "gtk_notebook_get_current_page" :int [:ptr])
(ffi/defbind gtk-notebook-set-current-page libgtk "gtk_notebook_set_current_page" :void [:ptr :int])

# ── GtkPaned ─────────────────────────────────────────────────────

(ffi/defbind gtk-paned-new        libgtk "gtk_paned_new"                 :ptr   [:int])
(ffi/defbind gtk-paned-set-start-child libgtk "gtk_paned_set_start_child" :void [:ptr :ptr])
(ffi/defbind gtk-paned-set-end-child   libgtk "gtk_paned_set_end_child"   :void [:ptr :ptr])

# ── GtkCenterBox ──────────────────────────────────────────────────

(ffi/defbind gtk-center-box-new   libgtk "gtk_center_box_new"            :ptr   [])
(ffi/defbind gtk-center-box-set-start-widget  libgtk "gtk_center_box_set_start_widget"  :void [:ptr :ptr])
(ffi/defbind gtk-center-box-set-center-widget libgtk "gtk_center_box_set_center_widget" :void [:ptr :ptr])
(ffi/defbind gtk-center-box-set-end-widget    libgtk "gtk_center_box_set_end_widget"    :void [:ptr :ptr])

# ── GtkOverlay ────────────────────────────────────────────────────

(ffi/defbind gtk-overlay-new      libgtk "gtk_overlay_new"               :ptr   [])
(ffi/defbind gtk-overlay-set-child    libgtk "gtk_overlay_set_child"     :void  [:ptr :ptr])
(ffi/defbind gtk-overlay-add-overlay  libgtk "gtk_overlay_add_overlay"   :void  [:ptr :ptr])

# ── GtkRevealer ──────────────────────────────────────────────────

(ffi/defbind gtk-revealer-new     libgtk "gtk_revealer_new"              :ptr   [])
(ffi/defbind gtk-revealer-set-child       libgtk "gtk_revealer_set_child"             :void [:ptr :ptr])
(ffi/defbind gtk-revealer-set-reveal-child libgtk "gtk_revealer_set_reveal_child"     :void [:ptr :int])
(ffi/defbind gtk-revealer-set-transition-type libgtk "gtk_revealer_set_transition_type" :void [:ptr :int])

# ── GtkImage ──────────────────────────────────────────────────────

(ffi/defbind gtk-image-new-from-file libgtk "gtk_image_new_from_file"    :ptr   [:string])
(ffi/defbind gtk-image-new-from-icon-name libgtk "gtk_image_new_from_icon_name" :ptr [:string])
(ffi/defbind gtk-image-set-pixel-size libgtk "gtk_image_set_pixel_size"  :void  [:ptr :int])
...
(ffi/defbind gtk-css-provider-load-from-string libgtk "gtk_css_provider_load_from_string" :void [:ptr :string])
(ffi/defbind gtk-style-context-add-provider-for-display libgtk "gtk_style_context_add_provider_for_display" :void [:ptr :ptr :uint])
...
{:libgtk libgtk :libglib libglib :libgobj libgobj
 :libwebkit libwebkit :libjsc libjsc
 # gtk init
 :gtk-init gtk-init
 # window
 ...
 :gtk-toggle-button-get-active gtk-toggle-button-get-active
 # entry
 ...
 :gtk-editable-set-text gtk-editable-set-text
 # text view
 ...
 :gtk-drop-down-set-selected gtk-drop-down-set-selected
 # search
 :gtk-search-entry-new gtk-search-entry-new
 # progress
 :gtk-progress-bar-new gtk-progress-bar-new
 :gtk-progress-bar-set-fraction gtk-progress-bar-set-fraction
 :gtk-progress-bar-get-fraction gtk-progress-bar-get-fraction
 # spinner
 :gtk-spinner-new gtk-spinner-new
 :gtk-spinner-start gtk-spinner-start
 :gtk-spinner-stop gtk-spinner-stop
 # separator
 :gtk-separator-new gtk-separator-new
 # scroll
 ...
 :gtk-scrolled-window-set-min-content-width gtk-scrolled-window-set-min-content-width
 # expander
 :gtk-expander-new gtk-expander-new
 :gtk-expander-set-child gtk-expander-set-child
 :gtk-expander-set-expanded gtk-expander-set-expanded
 # frame
 :gtk-frame-new gtk-frame-new
 :gtk-frame-set-child gtk-frame-set-child
 # grid
 :gtk-grid-new gtk-grid-new
 :gtk-grid-attach gtk-grid-attach
 :gtk-grid-set-row-spacing gtk-grid-set-row-spacing
 :gtk-grid-set-column-spacing gtk-grid-set-column-spacing
 # stack
 ...
 :gtk-stack-get-visible-child-name gtk-stack-get-visible-child-name
 # notebook
 ...
 :gtk-notebook-set-current-page gtk-notebook-set-current-page
 # paned
 :gtk-paned-new gtk-paned-new
 :gtk-paned-set-start-child gtk-paned-set-start-child
 :gtk-paned-set-end-child gtk-paned-set-end-child
 # center-box
 ...
 :gtk-center-box-set-end-widget gtk-center-box-set-end-widget
 # overlay
 :gtk-overlay-new gtk-overlay-new
 :gtk-overlay-set-child gtk-overlay-set-child
 :gtk-overlay-add-overlay gtk-overlay-add-overlay
 # revealer
 ...
 :gtk-revealer-set-transition-type gtk-revealer-set-transition-type
 # image
 :gtk-image-new-from-file gtk-image-new-from-file
 :gtk-image-new-from-icon-name gtk-image-new-from-icon-name
 :gtk-image-set-pixel-size gtk-image-set-pixel-size
 # calendar
 :gtk-calendar-new gtk-calendar-new
 # css
 ...
 :gdk-display-get-default gdk-display-get-default
 # glib
 ...
 :jsc-value-to-string jsc-value-to-string
 # constants
