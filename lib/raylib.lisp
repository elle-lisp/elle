...
(fn []
  ...
  (ffi/defbind c-begin-scissor-mode
               lib
               "BeginScissorMode"
  ...
  (ffi/defbind c-draw-line-ex
               lib
               "DrawLineEx"
               :void [vec2-type vec2-type :float color-type])
  (ffi/defbind c-draw-line-bezier
               lib
               "DrawLineBezier"
               :void [vec2-type vec2-type :float color-type])
  (ffi/defbind c-draw-circle
               lib
               "DrawCircle"
               :void [:int :int :float color-type])
  (ffi/defbind c-draw-circle-gradient
               lib
               "DrawCircleGradient"
               :void [:int :int :float color-type color-type])
  (ffi/defbind c-draw-circle-lines
               lib
               "DrawCircleLines"
               :void [:int :int :float color-type])
  (ffi/defbind c-draw-ellipse
               lib
               "DrawEllipse"
               :void [:int :int :float :float color-type])
  (ffi/defbind c-draw-rectangle
               lib
               "DrawRectangle"
               :void [:int :int :int :int color-type])
  (ffi/defbind c-draw-rectangle-rec
               lib
               "DrawRectangleRec"
               :void [rect-type color-type])
  (ffi/defbind c-draw-rectangle-pro
               lib
               "DrawRectanglePro"
               :void [rect-type vec2-type :float color-type])
  (ffi/defbind c-draw-rectangle-gradient-v
               lib
               "DrawRectangleGradientV"
               :void [:int :int :int :int color-type color-type])
  (ffi/defbind c-draw-rectangle-gradient-h
               lib
               "DrawRectangleGradientH"
               :void [:int :int :int :int color-type color-type])
  (ffi/defbind c-draw-rectangle-lines
               lib
               "DrawRectangleLines"
               :void [:int :int :int :int color-type])
  (ffi/defbind c-draw-rectangle-lines-ex
               lib
               "DrawRectangleLinesEx"
               :void [rect-type :float color-type])
  (ffi/defbind c-draw-rectangle-rounded
               lib
               "DrawRectangleRounded"
               :void [rect-type :float :int color-type])
  (ffi/defbind c-draw-rectangle-rounded-lines
               lib
               "DrawRectangleRoundedLines"
               :void [rect-type :float :int color-type])
  (ffi/defbind c-draw-rectangle-rounded-lines-ex
               lib
               "DrawRectangleRoundedLinesEx"
               :void [rect-type :float :int :float color-type])
  (ffi/defbind c-draw-triangle
               lib
               "DrawTriangle"
               :void [vec2-type vec2-type vec2-type color-type])
  (ffi/defbind c-draw-triangle-lines
               lib
               "DrawTriangleLines"
               :void [vec2-type vec2-type vec2-type color-type])
  (ffi/defbind c-draw-poly
               lib
               "DrawPoly"
               :void [vec2-type :int :float :float color-type])
  (ffi/defbind c-draw-poly-lines
               lib
               "DrawPolyLines"
               :void [vec2-type :int :float :float color-type])
  (ffi/defbind c-draw-ring
               lib
               "DrawRing"
               :void [vec2-type :float :float :float :float :int color-type])
  (ffi/defbind c-draw-ring-lines
               lib
               "DrawRingLines"
               :void [vec2-type :float :float :float :float :int color-type])
  ...
  (ffi/defbind c-draw-line-3d
               lib
               "DrawLine3D"
               :void [vec3-type vec3-type color-type])
  (ffi/defbind c-draw-cube
               lib
               "DrawCube"
               :void [vec3-type :float :float :float color-type])
  (ffi/defbind c-draw-cube-wires
               lib
               "DrawCubeWires"
               :void [vec3-type :float :float :float color-type])
  (ffi/defbind c-draw-sphere
               lib
               "DrawSphere"
               :void [vec3-type :float color-type])
  (ffi/defbind c-draw-sphere-ex
               lib
               "DrawSphereEx"
               :void [vec3-type :float :int :int color-type])
  (ffi/defbind c-draw-sphere-wires
               lib
               "DrawSphereWires"
               :void [vec3-type :float :int :int color-type])
  (ffi/defbind c-draw-cylinder
               lib
               "DrawCylinder"
               :void [vec3-type :float :float :float :int color-type])
  (ffi/defbind c-draw-cylinder-wires
               lib
               "DrawCylinderWires"
               :void [vec3-type :float :float :float :int color-type])
  (ffi/defbind c-draw-plane
               lib
               "DrawPlane"
  ...
  (ffi/defbind c-is-mouse-button-released
               lib
  ...
  (ffi/defbind c-is-gamepad-button-pressed
               lib
               "IsGamepadButtonPressed"
               :bool [:int :int])
  (ffi/defbind c-is-gamepad-button-down
               lib
               "IsGamepadButtonDown"
               :bool [:int :int])
  (ffi/defbind c-get-gamepad-axis-movement
               lib
  ...
  (ffi/defbind c-check-collision-recs
               lib
               "CheckCollisionRecs"
               :bool [rect-type rect-type])
  (ffi/defbind c-check-collision-circles
               lib
               "CheckCollisionCircles"
               :bool [vec2-type :float vec2-type :float])
  (ffi/defbind c-check-collision-circle-rec
               lib
               "CheckCollisionCircleRec"
               :bool [vec2-type :float rect-type])
  (ffi/defbind c-check-collision-point-rec
               lib
               "CheckCollisionPointRec"
               :bool [vec2-type rect-type])
  (ffi/defbind c-check-collision-point-circle
               lib
               "CheckCollisionPointCircle"
               :bool [vec2-type vec2-type :float])
  (ffi/defbind c-get-collision-rec
               lib
               "GetCollisionRec"
               rect-type
               [rect-type rect-type])
  ...
  (defn texture-width [tex]
    (get tex 1))
  (defn texture-height [tex]
    (get tex 2))
  (defn texture-size [tex]
    {:width (get tex 1) :height (get tex 2)})
  ...
  (defn window-fullscreen? []
    (c-is-window-fullscreen))
  (defn window-hidden? []
    (c-is-window-hidden))
  (defn window-minimized? []
    (c-is-window-minimized))
  (defn window-maximized? []
    (c-is-window-maximized))
  (defn window-focused? []
    (c-is-window-focused))
  (defn window-resized? []
    (c-is-window-resized))
  ...
  (defn clear-window-state [flags]
    (c-clear-window-state flags))
  (defn toggle-fullscreen []
    (c-toggle-fullscreen))
  (defn set-window-title [title]
    (c-set-window-title title))
  (defn set-window-position [x y]
    (c-set-window-position x y))
  (defn set-window-size [w h]
    (c-set-window-size w h))
  (defn screen-width []
    (c-get-screen-width))
  (defn screen-height []
    (c-get-screen-height))
  ...
  (defn set-target-fps [fps]
    (c-set-target-fps fps))
  (defn fps []
    (c-get-fps))
  (defn frame-time []
    (c-get-frame-time))
  ...
  (defn end-blend-mode []
    (c-end-blend-mode))
  (defn begin-scissor-mode [x y w h]
    (c-begin-scissor-mode x y w h))
  ...
  (defn draw-rect-rounded-lines-ex [rec roundness segments thick col]
    (c-draw-rectangle-rounded-lines-ex rec
      (float roundness)
      segments
      (float thick)
      col))
  ...
  (defn unload-image [img]
    (c-unload-image img))
  (defn export-image [img path]
    (c-export-image img path))
  (defn gen-image-color [w h col]
    (c-gen-image-color w h col))
  (defn load-texture-from-image [img]
    (c-load-texture-from-image img))

  # ── Public API: Input — keyboard ─────────────────────────────────────

  (defn key-pressed? [key]
    (c-is-key-pressed key))
  (defn key-down? [key]
    (c-is-key-down key))
  (defn key-released? [key]
    (c-is-key-released key))
  (defn key-up? [key]
    (c-is-key-up key))
  (defn key-pressed []
    (c-get-key-pressed))
  (defn char-pressed []
    (c-get-char-pressed))
  (defn set-exit-key [key]
    (c-set-exit-key key))

  # ── Public API: Input — mouse ────────────────────────────────────────

  (defn mouse-button-pressed? [btn]
    (c-is-mouse-button-pressed btn))
  (defn mouse-button-down? [btn]
    (c-is-mouse-button-down btn))
  (defn mouse-button-released? [btn]
    (c-is-mouse-button-released btn))
  (defn mouse-button-up? [btn]
    (c-is-mouse-button-up btn))
  (defn mouse-x []
    (c-get-mouse-x))
  (defn mouse-y []
    (c-get-mouse-y))
  ...
  (defn mouse-wheel []
    (c-get-mouse-wheel-move))
  (defn set-mouse-cursor [cursor]
    (c-set-mouse-cursor cursor))
  (defn show-cursor []
    (c-show-cursor))
  (defn hide-cursor []
    (c-hide-cursor))
  ...
  (defn gamepad-available? [pad]
    (c-is-gamepad-available pad))
  (defn gamepad-button-pressed? [pad btn]
    (c-is-gamepad-button-pressed pad btn))
  (defn gamepad-button-down? [pad btn]
  ...
  (defn init-audio []
    (c-init-audio-device))
  (defn close-audio []
    (c-close-audio-device))
  (defn audio-ready? []
    (c-is-audio-device-ready))
  (defn set-master-volume [v]
    (c-set-master-volume (float v)))
  (defn master-volume []
    (c-get-master-volume))
  (defn load-sound [path]
    (c-load-sound path))
  (defn unload-sound [snd]
    (c-unload-sound snd))
  (defn play-sound [snd]
    (c-play-sound snd))
  (defn stop-sound [snd]
    (c-stop-sound snd))
  (defn pause-sound [snd]
    (c-pause-sound snd))
  (defn resume-sound [snd]
    (c-resume-sound snd))
  (defn sound-playing? [snd]
    (c-is-sound-playing snd))
  (defn set-sound-volume [snd v]
    (c-set-sound-volume snd (float v)))
  (defn set-sound-pitch [snd p]
    (c-set-sound-pitch snd (float p)))
  (defn set-sound-pan [snd p]
    (c-set-sound-pan snd (float p)))
  ...
  (defn set-config-flags [flags]
    (c-set-config-flags flags))
  (defn set-trace-log-level [lvl]
    (c-set-trace-log-level lvl))
  (defn random-value [lo hi]
    (c-get-random-value lo hi))
  (defn take-screenshot [path]
    (c-take-screenshot path))
  (defn open-url [url]
    (c-open-url url))
...

  {
   ...
   :begin-mode-2d begin-mode-2d
   :end-mode-2d end-mode-2d
   :with-mode-2d with-mode-2d
   :begin-mode-3d begin-mode-3d
   :end-mode-3d end-mode-3d
   :with-mode-3d with-mode-3d
   :begin-blend-mode begin-blend-mode
   :end-blend-mode end-blend-mode
   :begin-scissor-mode begin-scissor-mode
   :end-scissor-mode end-scissor-mode

   # shapes
   :draw-pixel draw-pixel
   :draw-line draw-line
   :draw-line-ex draw-line-ex
   :draw-line-bezier draw-line-bezier
   :draw-circle draw-circle
   :draw-circle-gradient draw-circle-gradient
   :draw-circle-lines draw-circle-lines
   :draw-ellipse draw-ellipse
   :draw-rect draw-rect
   :draw-rect-rec draw-rect-rec
   :draw-rect-pro draw-rect-pro
   :draw-rect-gradient-v draw-rect-gradient-v
   :draw-rect-gradient-h draw-rect-gradient-h
   :draw-rect-lines draw-rect-lines
   :draw-rect-lines-ex draw-rect-lines-ex
   ...
   :draw-triangle-lines draw-triangle-lines
   :draw-poly draw-poly
   :draw-poly-lines draw-poly-lines
   :draw-ring draw-ring
   :draw-ring-lines draw-ring-lines
   ...
   :draw-fps draw-fps
   :draw-text draw-text
   :draw-text-ex draw-text-ex
   :draw-text-pro draw-text-pro
   :measure-text measure-text
   :measure-text-ex measure-text-ex
   :default-font default-font
   :load-font load-font
   :load-font-ex load-font-ex
   ...
   :draw-texture-v draw-texture-v
   :draw-texture-ex draw-texture-ex
   :draw-texture-rec draw-texture-rec
   ...
   # config flags
   :FLAG_VSYNC FLAG_VSYNC
   :FLAG_FULLSCREEN FLAG_FULLSCREEN
   :FLAG_RESIZABLE FLAG_RESIZABLE
   :FLAG_UNDECORATED FLAG_UNDECORATED
   :FLAG_HIDDEN FLAG_HIDDEN
   :FLAG_MINIMIZED FLAG_MINIMIZED
   :FLAG_MAXIMIZED FLAG_MAXIMIZED
   :FLAG_TOPMOST FLAG_TOPMOST
   :FLAG_ALWAYS_RUN FLAG_ALWAYS_RUN
   :FLAG_TRANSPARENT FLAG_TRANSPARENT
   :FLAG_HIGHDPI FLAG_HIGHDPI
   :FLAG_MSAA_4X FLAG_MSAA_4X
